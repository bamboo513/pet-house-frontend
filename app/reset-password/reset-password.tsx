    ...
    return (
        <div className="flex items-center justify-center min-h-svh">
            <section className="flex flex-col items-center justify-center w-md rounded-lg">
                ...
                <h2 className="text-2xl font-semibold mb-2">รีเซ็ตรหัสผ่าน</h2>
                <p className="text-sm mb-5 text-center text-muted-foreground">กรุณาตั้งรหัสผ่านใหม่สำหรับบัญชีของคุณ</p>
